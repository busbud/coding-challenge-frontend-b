...
exports.initial_search = function(req, res){
	response = res
	var request = require('request');
	query_string = req.query.date+"?adult="+req.query.adult+"&senior="+req.query.senior+"&child="+req.query.child+"&lang=en"+"&currency="+req.query.currency
	request({
	    headers: {
				    'Accept': 'application/vnd.busbud+json; version=2; profile=https://schema.busbud.com/v2/',
				    'X-Busbud-Token': 'PARTNER_JSWsVZQcS_KzxNRzGtIt1A'
				},
	    uri: 'https://napi.busbud.com/x-departures/dr5reg/f25dvk/'+query_string,
	    method: 'GET'
