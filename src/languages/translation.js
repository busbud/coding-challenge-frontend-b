...
export const Translation = new LocalizedStrings({
    en: {
        ...
        fetchErrorMessage: 'Oops! We encountered an error. Please try again later.',
        days: 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday',
        months: 'January,February,March,April,May,June,July,August,September,October,November,December',
        noDepartures: 'No departures available at the moment. Please try again later.'
    },
    fr: {
        ...
        fetchErrorMessage: 'Oops! Nous avons rencontré une erreur. Veuillez réessayer plus tard.',
        days: 'Dimanche,Lundi,Mardi,Mercredi,Jeudi,Vendredi,Samedi',
        months: 'Janvier,Février,Mars,Avril,Mai,Juin,Juillet,Août,Septembre,Octobre,Novembre,Nécembre',
        noDepartures: 'Aucun départ disponible pour le moment. Veuillez réessayer plus tard.'
    }
});