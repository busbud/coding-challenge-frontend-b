...
import loader from './loader-blue.gif'
...
export default function List({latestData, isLoading, error, enabled}){
    ...
    return(
        <div className="list">
            ...
            {loadingInitialResults && <img className="loading" src={loader}/>}
            {pollingMoreResults && <div className="polling"><span>{t("polling")}</span><img src={loader}/></div>}
