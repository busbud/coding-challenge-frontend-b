...
import BudTravelCard, { BudTravelCardProps } from './BudTravelCard';

export default {
  title: 'Components/BudTravelCard',
  component: BudTravelCard,
};

const Template: Story<BudTravelCardProps> = args =>
  (
    <BudTravelCard {...args} />
  );
