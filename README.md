...
## Important comments
- Used frameworks: React and Bootstrap
- Since 2nd of August 2020 is a past time and there are no departures from OSHEAGA 2021 dates, a random api-working day was chosen: 1/12/2020.

## Features
- Shows placeholders while fetching data.
- Lists the available departures. (Showing date, time, city, location name, duration and price).
...
### Development
Clone this repository, navigate to it's root folder and run:
1. ```npm install```
2. ```npm start```
