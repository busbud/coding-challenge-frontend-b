...
function fetchData(source, destination, date, params, poll = false) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    busbud.get(requestUrl, params).then(function(response) {
      ...
      gatheredData.locations = gatheredData.locations.concat(response.data.locations);
      gatheredData.departures = gatheredData.departures.concat(response.data.departures);
